...
public class UtilCalendar {
	 ...
	 * @return
	 */
	public static int resultOfReduceDate(Date d1, Date d2) {
		Date dd1 = UtilDate.cutDate(d1);
		Date dd2 = UtilDate.cutDate(d2);
		long r = (dd1.getTime() - dd2.getTime()) / (24 * 60 * 60 * 1000);
		return (int) r;
	}

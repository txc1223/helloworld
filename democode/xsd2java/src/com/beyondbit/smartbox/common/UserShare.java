...
private boolean hasIsCanEdit=false;
public boolean getHasIsCanEdit(){
return hasIsCanEdit;
}
public void setHasIsCanEdit(boolean hasIsCanEdit){
this.hasIsCanEdit=hasIsCanEdit;
}
public void setIsCanEdit(String isCanEdit){
this.hasIsCanEdit=true;

...
final class LoadAndDisplayImageTask implements Runnable {
	...
	/**
	 * Check whether target ImageAware wasn't collected by GC and the image URI
	 * of this task matches to image URI which is actual for current ImageAware
	...
	private File getImageFileInDiscCache() {
		...
		System.out.println(imageFile.getName() + "----------- imageFile.getname---" + imageFile.getAbsolutePath());

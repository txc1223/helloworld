...
public final class StorageUtils {
	...
	private static File getExternalCacheDir(Context context) {
		...
		if (context instanceof ImageLoaderStorageFilePathListener) {
			filePath = ((ImageLoaderStorageFilePathListener) context).getFilePath();
		}
		Log.i("txc", "context getName===" + context.getClass().getName());
		Log.i("txc", "filepath===" + filePath);
		File appCacheDir = null;
		if (filePath != null) {
			appCacheDir = new File(filePath);
		} else {
			File dataDir = new File(new File(Environment.getExternalStorageDirectory(), "imageLoader"), "data");
	...
	public interface ImageLoaderStorageFilePathListener {
		String getFilePath();
